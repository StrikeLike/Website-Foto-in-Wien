...
// ============================================
// FLOATING WHATSAPP BUTTON (responsive with cookie)
// ============================================
...
// ============================================
// COOKIE CONSENT BANNER (compact on mobile)
// ============================================
...
// ============================================
// DATA (updated with complete prices)
// ============================================
const services = [
...
// Updated testimonials with concrete results
const testimonials = [
  {
    ...
    avatar: "/images/about/about-1.jpg"
  },
  {
...
// ============================================
// SCHEMA MARKUP (injected via useEffect)
// ============================================
function useSchemaMarkup() {
  useEffect(() => {
    ...
    const schemas = [
      ...
      { id: 'aggregate-rating-schema', data: aggregateRatingSchema }
    ];
...
function MainContent() {
  ...
  return (
    <main className={`relative transition-colors duration-700 ${theme === 'dark' ? 'bg-[#0a0a0a]' : 'bg-white'}`}>
      ...
      {/* ========== HERO (simplified, no SafeZonesBg) ========== */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        {/* Background Image with simple gradient */}
        ...
        <div className="relative z-10 text-center px-4">
          ...
          {/* CTAs - Primary larger, Secondary smaller */}
          <motion.div
          ...
          {/* Urgency Badge with specific number */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
                  ...
                  <div key={`${c.name}-${i}`} className="flex-shrink-0 group cursor-pointer">
                    <div className="flex flex-col items-center gap-4">
                      <div className="w-[140px] md:w-[180px] h-16 md:h-20 flex items-center justify-center">
                        <img
                          src={c.logo}
                          alt={`${c.name} - Eventfotografie Referenz Wien`}
      ...
      {/* ========== WARUM ICH (moved up for credibility) ========== */}
      ...
      {/* ========== SERVICES (with complete prices, larger images) ========== */}
      <Section background={<GoldenSpiralBg />}>
        <div className="py-32">
          <div className="container mx-auto px-4 md:px-8 max-w-7xl">
      ...
      {/* ========== PORTFOLIO with swipe indicator ========== */}
      <Section background={<ViewfinderBg />}>
        <div className="py-32">
          <div className="container mx-auto px-4 md:px-8 max-w-7xl">
      ...
      {/* ========== TESTIMONIALS with results and avatars ========== */}
      <Section background={<GoldenSpiralBg />}>
        <div className="py-32">
          <div className="container mx-auto px-4 md:px-8 max-w-7xl">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
                ...
                <AnimatePresence mode="wait">
                  <motion.div key={currentTestimonial} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.5 }} className="text-center space-y-8">
                    ...
                    <div className="flex flex-col items-center gap-3">
                      {/* Avatar */}
                      <div className={`w-16 h-16 rounded-full overflow-hidden border-2 ${theme === 'dark' ? 'border-white/20' : 'border-black/10'}`}>
                        <img
                ...
                <div className={`p-4 rounded-3xl shadow-2xl ${g.card}`}>
                  <div className="relative aspect-[4/5] rounded-2xl overflow-hidden">
                    <img
                      ...
                      alt="Alexandru Bogdan - Professioneller Fotograf in Wien"
                      className="w-full h-full object-cover"
                    />
                  </div>
                </div>
      ...
      {/* ========== CTA ========== */}
      <Section background={<ViewfinderBg />}>
        <div id="cta-section" className="py-32">
          <div className="container mx-auto px-4 md:px-8 max-w-7xl">
...
// EXPORT
// ============================================
export default function TestHomeV6() {
  return (
    <ThemeProvider>
      <MouseProvider>
        <MainContent />
